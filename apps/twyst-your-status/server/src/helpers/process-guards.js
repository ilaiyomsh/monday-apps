...
// the boot-time guards (version read, dependency init). VENDORED from the cross-app
// server template (canonical: error-guard templates/server; twin copies live in
// deadline-confirm / telemetry-dashboard / sync-calender). Extracted from index.js
