// SOURCE: ported from apps/Axis/Day-off ג€” src/components/ui/Rng.tsx (the
...
// the string ג€” that broke on copy-paste; the dir attribute is the stable fix.
 ...
 *   same day  ג†’ "5.7"      same month ג†’ "13-15.7"
 *   same year ג†’ "2.6-10.6" cross-year ג†’ "28.12.25-2.1.26"
 */
