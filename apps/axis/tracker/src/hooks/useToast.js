...
export const useToast = () => {
    ...
    const showToast = useCallback((message, type = 'info', duration = 1500, errorDetails = null, onRetry = null) => {
        ...
        const newToast = { id, message, type, duration, errorDetails, onRetry };
