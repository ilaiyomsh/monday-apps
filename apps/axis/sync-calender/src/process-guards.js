 ...
 */
export function installProcessGuards({ logger, flush, exit = (code) => process.exit(code) }) {
  ...
  // clean container. Returns the flush→exit promise so callers/tests can await it.
