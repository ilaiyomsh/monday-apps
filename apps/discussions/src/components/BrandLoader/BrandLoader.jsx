...
// orbit the table. Seats are colored along the Twyst signature gradient
// (indigo #6161FF -> sky #97AEFF -> magenta #E271FF -> peach #FFA88D).
// viewBox 140, center (70,70), seats at radius 40.
const SEATS = [
  { x: 110, y: 70, c: '#6161FF' },
  ...
  return (
    ...
    >
      <div className={styles.inner}>
        ...
        <svg className={styles.squiggle} viewBox="0 0 140 46" width="132" height="43" aria-hidden="true">
          <defs>
        ...
        <div className={styles.textBlock}>
          ...
          <div className={styles.poweredBy}>Powered by twyst<span className={styles.dot}>.</span></div>
        </div>
      </div>
    </div>
  );
