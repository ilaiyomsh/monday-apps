      ...
      boards: [
        {
          ...
          board_kind: 'public',
          columns: [
            // Typed `settings` objects (the parsed form the API delivers; the old
            // stringified-settings field is deprecated since 2025-10 and no longer selected).
            { id: 'name', title: 'שם', type: 'name', settings: {} },
            { id: 'status', title: 'סטטוס', type: 'status', settings: { labels: { 0: 'בעבודה', 1: 'בוצע', 2: 'תקוע' }, labels_colors: { 0: { color: '#fdab3d' }, 1: { color: '#00c875' }, 2: { color: '#e2445c' } } } },
