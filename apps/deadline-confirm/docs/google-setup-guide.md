...
2. חייב להיות **משתמש מלא עם רישיון Gmail פעיל** — קבוצה, alias או תיבה
   ללא רישיון לא יעבדו. השליחה (SMTP XOAUTH2) מזדהה כמשתמש Gmail מאומת,
   ורק תיבה מלאה יכולה להזדהות כך.
...
3. להעביר אותה: (א) לעצמך — **צפוי לא לרנדר לעולם**: הודעה לעצמך לא עוברת
   hop יוצא ואין לה headers של אימות (ממצאים §3), הרגל הזו נשארת רק כדי
   לראות אם חלק ה-AMP שרד את ההעברה; (ב) לעובד פנימי, (ג) לכתובת חיצונית —
   אלה שתי הרגליים שמעידות על רינדור.
