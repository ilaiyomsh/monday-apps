...
// Columns: name | that cluster's date | ONE <select> dropdown for labels
// (AMP-for-Email native select inside amp-form — not amp-accordion/bind).
...
const STYLES = `
      ...
      /* monday-like status picker width/height; AMP-safe (no position). */
      select.label-dd {
        width:200px;
        max-width:100%;
        height:34px;
