...
// policy. `/oauth/start` puts that path within reach of anyone, so 10k unauthenticated
// requests meant 10k Axiom writes — an external party choosing our ingest bill. Entropy
// and the 401 already protect the DATA; this protects the BUDGET.
//
