 ...
 * logging point. Display to the user is NOT done here — a UI sink (see the
...
export const setupGlobalErrorHandlers = (options = {}) => {
    ...
    window.addEventListener('error', (event) => {
        ...
        // through this branch silently and was never recorded. Warn — not error
        // — because a missing asset should not pop an error toast, but it must
